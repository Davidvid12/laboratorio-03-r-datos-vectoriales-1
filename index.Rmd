...
ggplot(centro_america, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Centro América, Esperanza De Vida") +
  xlab("Paises") + 
  ylab("Esperanza de vida") +  
  geom_col() +
  geom_text(aes(label=lifeExp), vjust=-0.3, size=3.5)
...
```{r}
plot(centro_america["lifeExp"], main="Centro América, Esperenza De Vida")
...
```{r}
centroamerica_extracto <- centro_america[centro_america$lifeExp>=74,]
plot(centroamerica_extracto["lifeExp"], main="CA, Paises y su esperanza de vida mayor o igual a 74 años ")
